...
pub struct KeysConfig {
    ...
    /// Open the agent grid overlay. Default: "prefix+a"
    pub agent_grid: BindingConfig,
...
pub(crate) struct KeysConfigOverlay {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    agent_grid: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KeysConfig {
    ...
    pub(crate) fn local_profile(&self, keybinds: &Keybinds) -> KeysConfigOverlay {
        ...
        copy_effective_action_field!(agent_grid, keybinds.agent_grid);
...
impl Default for KeysConfig {
    fn default() -> Self {
        Self {
            ...
            agent_grid: BindingConfig::one("prefix+a"),
